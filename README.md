...
<h2>Like the mess it is in terms of dependencies and like shit you need to know to make it work is awfull. GOD ! This repo is a construction site. Fixing my stuff ASAP :)</h2>
...
Global changes :
-
- Added a '__ _init_ __.py' file (it's empty for the moment)
